...
| タイミング | ファイル | 内容 |
|-----------|---------|------|
| Phase 4: verify 後 | ![](attachment/2026-02-24_192754_os_setup_virtualmedia_verify_test/phase4-verify-mounted.png) | PVE ログインプロンプト (マウント前の OS 稼働中画面) |
| Phase 5: install 完了 | ![](attachment/2026-02-24_192754_os_setup_virtualmedia_verify_test/phase5-install-complete.png) | 電源 Off 後の画面 (640x480) |
| Phase 6: POST 92 スタック | ![](attachment/2026-02-24_192754_os_setup_virtualmedia_verify_test/phase6-boot-after-install.png) | DXE--BIOS PCI Bus Enumeration.. 画面 |
| Phase 6: リカバリ後 | ![](attachment/2026-02-24_192754_os_setup_virtualmedia_verify_test/phase6-recovery-check.png) | Debian 13 ログインプロンプト |
| Phase 7: PVE 稼働 | ![](attachment/2026-02-24_192754_os_setup_virtualmedia_verify_test/phase7-pve-running.png) | PVE カーネルでの稼働画面 |
| Phase 8: 最終検証 | ![](attachment/2026-02-24_192754_os_setup_virtualmedia_verify_test/phase8-final.png) | 最終稼働状態 |
